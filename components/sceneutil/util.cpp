...
void transformBoundingSphere (const osg::Matrix& matrix, osg::BoundingSphere& bsphere)
{
    ...
    osg::BoundingSphere::value_type sqrlen_xdash = xdash.length();

    ydash -= bsphere._center;
    osg::BoundingSphere::value_type sqrlen_ydash = ydash.length();

    zdash -= bsphere._center;
    osg::BoundingSphere::value_type sqrlen_zdash = zdash.length();
